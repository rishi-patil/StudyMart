          ...
          <div className="flex flex-col lg:flex-row gap-20 mb-20 items-center">
              ...
              <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
                  ...
                  <div className="absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700 flex lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-8">
                      ...
                      <div className="flex flex-row items-center px-7 lg:px-14 gap-5 border-r border-caribbeangreen-300">
                          <p className="text-3xl font-bold ">10</p>
                          <p className="text-caribbeangreen-300 text-sm">YEARS EXPERIENCE</p>
                      </div> 

                      <div className="flex flex-row items-center px-7 lg:px-14 gap-5">
